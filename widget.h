...
private slots:
    ...
    void on_position_changed(qint64 posution);
...
private:
    ...
    bool muted;
    const char* DEFAULT_PLAYLIST = "D:\\Repos\\Qt\\build-MediaPlayer-Desktop_Qt_5_12_12_MSVC2015_64bit-Debug\\debug\\playlist.m3u";
